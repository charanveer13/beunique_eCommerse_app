...
public class DashboardTopSellerCategoryAdapter extends RecyclerView.Adapter<DashboardTopSellerCategoryAdapter.ViewHolder> {
    ...
    public DashboardTopSellerCategoryAdapter(Context context, ArrayList<EOAllProductData> productsDataList) {
    ...
    @NonNull
    @Override
    public DashboardTopSellerCategoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.dashboard_product_category_recycler_row, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DashboardTopSellerCategoryAdapter.ViewHolder holder, final int position) {
