...
public class DashboardNewArrivalCategoryAdapter extends RecyclerView.Adapter <DashboardNewArrivalCategoryAdapter.ViewHolder> {
    ...
    public DashboardNewArrivalCategoryAdapter(Context context, ArrayList <EOAllProductData> productsDataList) {
    ...
    @NonNull
    @Override
    public DashboardNewArrivalCategoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from ( context ).inflate ( R.layout.dashboard_product_category_recycler_row, parent, false );
        return new ViewHolder ( view );
    }

    @Override
    public void onBindViewHolder(@NonNull DashboardNewArrivalCategoryAdapter.ViewHolder holder, final int position) {
