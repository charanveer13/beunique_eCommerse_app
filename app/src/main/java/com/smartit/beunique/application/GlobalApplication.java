package com.smartit.beunique.application;
...
public class GlobalApplication extends Application {
    ...
    private SessionSecuredPreferences sharedPref;
    ...
    public SessionSecuredPreferences sharedPreferences(String preferenceName) {
        if(this.sharedPref == null) {
            this.sharedPref = new SessionSecuredPreferences ( this.getBaseContext ( ), this.getBaseContext ( ).getSharedPreferences ( preferenceName, Context.MODE_PRIVATE ) );
        }
    ...
    public String packageName() {
        if(this.packageName == null) {
            ...
            this.packageName = info != null ? info.packageName : "com.smartit.beunique";
        }
