...
public class BUniqueEditText extends AppCompatEditText {

    public BUniqueEditText(Context context) {
        super ( context );
        init ( context );
    }

    public BUniqueEditText(Context context, AttributeSet attrs) {
        super ( context, attrs );
        init ( context );
    }

    public BUniqueEditText(Context context, AttributeSet attrs, int defStyleAttr) {
