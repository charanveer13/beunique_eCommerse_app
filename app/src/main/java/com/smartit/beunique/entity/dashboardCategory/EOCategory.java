...
public class EOCategory implements Serializable {
    ...
    @Expose
    private EOCategoryAssociations associations;
    ...
    public EOCategoryAssociations getAssociations() {
        return associations;
    }

    public void setAssociations(EOCategoryAssociations associations) {
