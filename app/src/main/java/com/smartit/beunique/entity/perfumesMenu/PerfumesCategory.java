...
public class PerfumesCategory implements Serializable{
    ...
    @Expose
    private PerfumesAssociations associations;
    ...
    public PerfumesAssociations getAssociations() {
        return associations;
    }

    public void setAssociations(PerfumesAssociations associations) {
